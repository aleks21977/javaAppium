...
public class MWMyListPageObject extends MyListsPageObject {
   ...
   static {
       FOLDER_BY_NAME_TPL = "xpath://*[@text='{FOLDER_NAME}']";
               ...
               REMOVE_FROM_SAVED_BUTTON = "xpath://ul[contains(@class,'watchlist')]//h3[contains(text(),'{TITLE}')]/../../a[contains(@class,'watched')]";////ul[contains(@class,'watchlist')]//h3[contains(text(),'{TITLE}')]/../../a[contains(@class,'watched')]
